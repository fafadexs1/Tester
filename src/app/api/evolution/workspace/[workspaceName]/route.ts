...
export async function POST() {
  console.warn("[API Evolution Workspace] Este endpoint (/api/evolution/workspace/[workspaceName]) está obsoleto. Use /api/evolution/trigger/[webhookId] para webhooks da API Evolution.");
