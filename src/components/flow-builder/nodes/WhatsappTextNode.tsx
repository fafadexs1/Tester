...
export const WhatsappTextNode: React.FC<NodeComponentProps> = ({ node, onUpdate, evolutionInstances, isLoadingEvolutionInstances }) => {
        ...
        <div className="space-y-2" data-no-drag="true">
            <div>
                ...
                <div className="relative">
                    ...
                    <VariableInserter fieldName="textMessage" isIconTrigger isTextarea onInsert={(v) => onUpdate(node.id, { textMessage: (node.textMessage || '') + v })} />
                </div>
