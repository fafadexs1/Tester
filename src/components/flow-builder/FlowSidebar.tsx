  ...
  const blockCategories = [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "supabase-delete-row", label: "Deletar Linha", icon: <Trash {...iconProps} className="text-red-500" />, description: "Remove um registro da tabela.", defaultData: { supabaseTableName: '', supabaseIdentifierColumn: '', supabaseIdentifierValue: '' } },
      ]
    },
    {
      value: "whatsapp",
